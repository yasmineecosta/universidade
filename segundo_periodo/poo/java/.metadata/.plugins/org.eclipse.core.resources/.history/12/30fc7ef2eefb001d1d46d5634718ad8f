...
public class ContaComum {
	...
	public void credito(double val) {
		...
		System.out.println("Credito: " + val + " Saldo: " + saldo);
	}
	...
	public void debito(double val) {
		...
		System.out.println("Debito: " + val + " Saldo: " + saldo);
		} else {
	...
	public String getExtrato(Date ini, Date fim) {
		int time = 0;
		String ext = "Periodo inicial: "+ini.getDate()+"/"+ini.getMonth()+" "+"Periodo final: "+fim.getDate()+"/"+fim.getMonth()+"\n";
		for (int i = 0; i < pos; i++) {
