/*
 * Computacao Grafica
 * Codigo Trabalho Final: Fireboy e WaterGirl - fase 1
 * Autores: Felipe Lages de Lima e Yasmine Martins da Costa e Silva
 */
...
enum animation_ids{paused, idle, walking, jumping, shooting};
...
//    setlocale(LC_ALL,"Portuguese");
    ...
    init_glut("Computacao Grafica: Fireboy e Watergirl", argc, argv);
...
void init_glut(const char *nome_janela, int argc, char** argv){
    ...
    //animation = glmLoadAnimation("models/fireboy.obj", paused, 1);
    animation = glmLoadAnimation("models/fireboy.obj", paused, 1);
    // animation = glmLoadAnimation("models/watergirl/animations/idle", idle, 50);
    ...
    printf(".");
    animation = glmLoadAnimation("models/ironman/animations/running", walking, 20);
